<?php
	...
	class Mailgun
	{
		...
		?>
			<div class="mailgun-list-widget-front <?php echo $widget_class_id; ?> widget row">
				<form class="list-form <?php echo $form_class_id; ?> col s12">
					<div class="mailgun-list-widget-inputs row">
						...
						<?php if (isset($args[ 'collect_name' ]) && intval($args[ 'collect_name' ]) === 1): ?>
							<p class="mailgun-list-widget-name col l4 m4 s12">
								<strong>Name:</strong>
								<input type="text" name="name"/>
							</p>
						<?php endif; ?>
						<p class="mailgun-list-widget-email col l4 m4 s12">
							<strong>Email:</strong>
